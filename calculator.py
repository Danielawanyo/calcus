...
#  entry for displaying the numbers and results
entry = tk.Entry(window, width=35, border=16 )
...
button_subtract = tk.Button(window, text="-", padx=41, pady=20, command=lambda: button_click("-"))
button_multiply = tk.Button(window, text="*", padx=41, pady=20, command=lambda: button_click("*"))
button_divide = tk.Button(window, text="/", padx=41, pady=20, command=lambda: button_click("/"))
